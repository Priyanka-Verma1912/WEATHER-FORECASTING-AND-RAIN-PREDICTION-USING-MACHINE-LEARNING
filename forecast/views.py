...
#filepath: c:\Users\priya\MachineLearningProject1\weatherproject\forecast\views.py
def weather_view(request):
    if request.method == 'POST':
        ...
        csv_path = os.path.join('C:\\Users\\priya\\MachineLearningProject1\\weather.csv')
